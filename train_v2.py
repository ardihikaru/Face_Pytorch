...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_root', type=str, default='data/faces112x112', help='train image root')
    parser.add_argument('--train_file_list', type=str, default='data/train_val/train.txt', help='train list')
    parser.add_argument('--lfw_test_root', type=str, default='data/faces112x112', help='lfw image root')
    parser.add_argument('--lfw_file_list', type=str, default='data/faces112x112/pairs.txt', help='lfw pair file list')
